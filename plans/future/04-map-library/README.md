...
| **L3** | **Map-selection UI.** At base-start, show the indexed maps; the player clicks one to load.  After selection, proceed to the area-pick → core-landing → wave-1 flow. | The library face. |
